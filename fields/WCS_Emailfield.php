    ...
    {        
        ...
        public function render( $post ) : string
        {
            return "
                ...
                <input type='email' id='{$this->element_id}' class='form-control' name='{$this->key}' aria-describedby='{$this->element_id}-help-text' placeholder='{$this->name}' value='{$this->getValue()}'>
