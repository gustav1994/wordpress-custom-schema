        ...
        public function render( $post ) : string
        {
            ...
            return "
                ...
                ". ($useInputGroup ? '<div class="input-group">' : '') ."
                    ...
                    <textarea id='{$this->element_id}' cols='4' class='form-control rounded-0' name='{$this->key}' aria-describedby='{$this->element_id}-help-text' placeholder='{$this->name}'>{$this->getValue()}</textarea>
