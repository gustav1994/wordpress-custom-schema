        ...
        public function render( $post ) : string
        {
            ...
            return "
                ...
                ". ($useInputGroup ? '<div class="input-group">' : '') ."
                    ...
                    <input type='text' id='{$this->element_id}' class='form-control rounded-0' name='{$this->key}' aria-describedby='{$this->element_id}-help-text' placeholder='{$this->name}' value='{$this->getValue()}'>
