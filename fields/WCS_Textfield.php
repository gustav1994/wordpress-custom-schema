    ...
    class WCS_Textfield extends WCS_Field
    {
        ...
        public function render( $post ) : string
        {
            return "
                ...
                <input type='text' id='{$this->element_id}' class='form-control' name='{$this->key}' aria-describedby='{$this->element_id}-help-text' placeholder='{$this->name}' value='".get_post_meta($post->ID, $this->key, true)."'>
